...
def function1():
    ...
    return x=np.arange(1,13).reshape(6,2)
    """
    expected output:
    [[ 1  2]
    [ 3  4]
...
def function3():
    ...
    x = a[(a%5==0) & (a%7==0)] # write code here  
    return x
    """
    Expected Output:
...
return x=np.full_like(x,0) #write your code here
...
brr = np.array([1,2,3])
ans = ans = np.where(arr%2!=0,-1,arr) #write your code here
return ans
...
return    ans=np.where(arr%3==0)& (arr%5==0),"Yes","No") #write your code here 
...
def function18():
    ...
    x=np.count_nonzero(np.where(students<101))+1 #write your code here 
    return x
